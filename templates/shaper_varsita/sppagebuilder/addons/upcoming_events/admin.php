        ...
        array(
            ...
            'attr' => array(
                'general' => array(
                    ...
                    'subtitle' => array(
                        'type' => 'text',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_UPCOMING_EVENTS_SUBTITLE'),
                        'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_UPCOMING_EVENTS_SUBTITLE_DESC'),
                        'std' => ''
                    ),
                    'limit' => array(
                        'type' => 'number',
                        'title' => JText::_('UPCOMING_EVENT_LIMIT'),
                        'desc' => JText::_('UPCOMING_EVENT_LIMIT_DESC'),
                        'std' => '12'
                    ),
                    'layout' => array(
                        'type' => 'select',
                        'title' => JText::_('UPCOMING_EVENT_LAYOUT'),
                        'desc' => JText::_('UPCOMING_EVENT_LAYOUT_DESC'),
                        'values' => array(
                            'carousel' => JText::_('UPCOMING_EVENT_LAYOUT_CAROUSEL'),
                            'honeycomb' => JText::_('UPCOMING_EVENT_LAYOUT_HONEYCOMB')
                        ),
                        'std' => 'carousel',
                    ),
                    'class' => array(
