...
SpAddonsConfig::addonConfig(
        array(
            'type' => 'content',
            'addon_name' => 'sp_quick_admission',
            'category' => 'Varsita',
            'title' => JText::_('COM_SPPAGEBUILDER_ADDON_QA'),
            'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_QA_DESC'),
            'inline'     => [
            ...
            'attr' => array(
                'general' => array(
                    ...
                    'degree' => array(
                        'type' => 'text',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_QA_DEGREE'),
                        'std' => ''
                    ),
                    'cource' => array(
                        'type' => 'text',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_QA_COURCE'),
                        'std' => ''
                    ),
                    'duration' => array(
                        'type' => 'text',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_QA_DURATION'),
                        'std' => ''
                    ),
                    'qa_description' => array(
                        'type' => 'editor',
